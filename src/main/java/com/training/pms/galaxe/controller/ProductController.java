...
public class ProductController {
    ...
    public ResponseEntity<Product> getProduct(@PathVariable("productId") Integer productId) {
     ...
     @GetMapping("searchByProductPriceRange/{minPrice}/{maxPrice}") // url - localhost:9090/product/2435678
     public ResponseEntity<List<Product>> getProductByName(@PathVariable("minPrice") Integer minPrice,@PathVariable("maxPrice") Integer maxPrice) {
